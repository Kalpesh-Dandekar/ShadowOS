...
export const syntheticDataset = Object.freeze({
  ...
  CUSTOMER_ACCOUNT: freezeRows([
    ...
    { id: "ACC-SIM-006", status: "inactive", inactiveSince: "2024-01-15", archived: false, dependencyCount: 0 },
    { id: "ACC-SIM-007", status: "inactive", inactiveSince: "2024-03-12", archived: false, dependencyCount: 0 },
    { id: "ACC-SIM-008", status: "inactive", inactiveSince: "2024-05-20", archived: false, dependencyCount: 0 },
    { id: "ACC-SIM-009", status: "inactive", inactiveSince: "2024-07-08", archived: false, dependencyCount: 0 },
    { id: "ACC-SIM-010", status: "inactive", inactiveSince: "2024-09-18", archived: false, dependencyCount: 0 },
    { id: "ACC-SIM-011", status: "inactive", inactiveSince: "2024-11-04", archived: false, dependencyCount: 0 },
    { id: "ACC-SIM-012", status: "inactive", inactiveSince: "2025-01-22", archived: false, dependencyCount: 0 },
    { id: "ACC-SIM-013", status: "inactive", inactiveSince: "2025-05-16", archived: false, dependencyCount: 0 },
    { id: "ACC-SIM-014", status: "inactive", inactiveSince: "2025-09-09", archived: false, dependencyCount: 0 },
  ]),
});
