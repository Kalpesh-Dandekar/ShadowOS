...
export function AuthShell({ children }: { children: ReactNode }) {
  ...
  return (
    <main className="grid min-h-screen bg-[var(--background)] lg:grid-cols-[1.08fr_0.92fr]">
      <section className="technical-grid relative hidden overflow-hidden border-r border-white/[0.07] p-10 lg:flex lg:flex-col lg:justify-between xl:p-14">
        <Brand />
        <div className="relative z-10 max-w-xl">
          ...
          <div className="mt-10 max-w-md rounded-[12px] border border-white/10 bg-[#0b0d10e6] p-5 shadow-[var(--shadow-panel)]">
