...
export function AuthForm({ mode }: { mode: AuthMode }) {
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit} className="mt-8 space-y-[18px]" noValidate={false}>
        ...
        <button type="submit" className="w-full rounded-[8px] bg-white px-4 py-3 text-sm font-medium text-black shadow-[0_8px_24px_rgb(255_255_255/0.06)] transition-colors hover:bg-zinc-200">{isRegister ? "Create Account" : "Sign In"}</button>
